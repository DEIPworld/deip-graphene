...
FC_REFLECT( deip::protocol::create_grant_operation, (target_discipline)(amount)(min_number_of_positive_reviews)(researches_to_grant)(start_time)(end_time)(creator))
