...
/*
 * This class represents the basic versioning scheme of the Deip blockchain.
...
namespace fc {
class variant;
void to_variant(const deip::protocol::version& v, variant& var);
void from_variant(const variant& var, deip::protocol::version& v);

void to_variant(const deip::protocol::hardfork_version& hv, variant& var);
void from_variant(const variant& var, deip::protocol::hardfork_version& hv);
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT(deip::protocol::version, (v_num))
FC_REFLECT_DERIVED(deip::protocol::hardfork_version, (deip::protocol::version), )

FC_REFLECT(deip::protocol::hardfork_version_vote, (hf_version)(hf_time))
