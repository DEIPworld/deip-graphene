...
#define DEIP_ASSERT(expr, exc_type, FORMAT, ...)                                                                     \
...
FC_DECLARE_DERIVED_EXCEPTION(
    tx_duplicate_sig, deip::protocol::transaction_exception, 3060000, "duplicate signature included")

#define DEIP_RECODE_EXC(cause_type, effect_type)                                                                     \
