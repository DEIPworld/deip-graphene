...
#define DEIP_LIMIT_DISCIPLINE_SUPPLIES_PER_OWNER          5
#define DEIP_LIMIT_DISCIPLINE_SUPPLIES_LIST_SIZE          DEIP_LIMIT_DISCIPLINE_SUPPLIES_PER_OWNER
#define DEIP_LIMIT_API_DISCIPLINE_SUPPLIES_LIST_SIZE      DEIP_LIMIT_DISCIPLINE_SUPPLIES_PER_OWNER
...
#define DEIP_REVIEWER_INFLUENCE_FACTOR 1.0
#define DEIP_CURATOR_INFLUENCE_FACTOR 1.0
