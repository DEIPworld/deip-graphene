...
fc::variant_object get_config()
{
    ...
    result["DEIP_COMMON_TOKENS_WITHDRAW_INTERVALS"] = DEIP_COMMON_TOKENS_WITHDRAW_INTERVALS;
    result["DEIP_COMMON_TOKENS_WITHDRAW_INTERVALS_PRE_HF_16"] = DEIP_COMMON_TOKENS_WITHDRAW_INTERVALS_PRE_HF_16;
    result["DEIP_COMMON_TOKENS_WITHDRAW_INTERVAL_SECONDS"] = DEIP_COMMON_TOKENS_WITHDRAW_INTERVAL_SECONDS;
    ...
    result["DEIP_LIMIT_DISCIPLINE_SUPPLIES_PER_GRANTOR"] = DEIP_LIMIT_DISCIPLINE_SUPPLIES_PER_GRANTOR;
    result["DEIP_LIMIT_DISCIPLINE_SUPPLIES_LIST_SIZE"] = DEIP_LIMIT_DISCIPLINE_SUPPLIES_LIST_SIZE;
    result["DEIP_LIMIT_API_DISCIPLINE_SUPPLIES_LIST_SIZE"] = DEIP_LIMIT_API_DISCIPLINE_SUPPLIES_LIST_SIZE;
