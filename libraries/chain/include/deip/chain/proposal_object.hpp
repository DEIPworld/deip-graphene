...
struct invite_member_proposal_data_type : member_proposal_data_type
{
    ...
    invite_member_proposal_data_type(const research_group_id_type& research_group_id,
            ...
            : member_proposal_data_type(research_group_id, name)
...
FC_REFLECT(deip::chain::invite_member_proposal_data_type, (research_group_token_amount))
