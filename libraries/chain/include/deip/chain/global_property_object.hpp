...
public:
    ...
    fc::uint128 total_disciplines_reward_weight;
...
FC_REFLECT(deip::chain::dynamic_global_property_object,
           (id)(head_block_number)(head_block_id)(time)(current_witness)(current_supply)(confidential_supply)(
               total_vesting_fund_deip)(total_vesting_shares)(total_reward_fund_deip)(total_reward_shares2)(total_disciplines_reward_weight)(maximum_block_size)(current_aslot)(
