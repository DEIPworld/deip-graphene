...
public:
    ...
    share_type all_used_expertise = 0;
};
...
FC_REFLECT(deip::chain::dynamic_global_property_object,
           (id)(head_block_number)(head_block_id)(time)(current_witness)(current_supply)(confidential_supply)(total_active_disciplines_reward_weight)(maximum_block_size)(current_aslot)(total_common_tokens_fund_deip)(total_expert_tokens_amount)(total_common_tokens_amount)(
