...
public:
    ...
    void check_research_group_existence(research_group_id_type research_group_id) const;
...
public:
    ...
    void check_research_token_existence(const account_name_type& account_name,
