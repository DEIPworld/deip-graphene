...
struct by_account;
typedef multi_index_container<account_history_object,
                              indexed_by<ordered_unique<tag<by_id>,
...
FC_REFLECT(deip::chain::account_history_object, (id)(account)(sequence)(op))
CHAINBASE_SET_INDEX_TYPE(deip::chain::account_history_object, deip::chain::account_history_index)
