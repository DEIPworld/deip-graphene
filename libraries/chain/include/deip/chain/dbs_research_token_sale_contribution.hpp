...
public:
    ...
    const research_token_sale_contribution_object& create_research_token_sale_contributiont(const research_id_type& research_id,
    ...
    research_token_sale_contribution_refs_type get_research_token_sale_contribution_by_research_id(const research_id_type& research_id) const;
