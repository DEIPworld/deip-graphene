...
public:
    ...
    const expertise_allocation_proposal_object& get_by_discipline_and_claimer(const discipline_id_type& discipline_id,
    ...
    void check_existence_by_discipline_and_claimer(const discipline_id_type& discipline_id,
                                                   const account_name_type& claimer);

    bool is_exists_by_discipline_and_claimer(const discipline_id_type& discipline_id,
