...
FC_REFLECT(deip::chain::research_content_object, (id)(research_id)(type)(title)(content)(authors)(created_at)(references)(external_references)(activity_round)(activity_state)(activity_window_start)(activity_window_end))
