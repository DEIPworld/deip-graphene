...
public:
    ...
    /** tracks the total payout this comment has received over time, measured in DEIP */
    asset total_payout_value = asset(0, DEIP_SYMBOL);
    asset curator_payout_value = asset(0, DEIP_SYMBOL);
    asset beneficiary_payout_value = asset(0, DEIP_SYMBOL);
    ...
    asset max_accepted_payout
        = asset(1000000000, DEIP_SYMBOL); /// DEIP value of the maximum payout this post will receive
...
FC_REFLECT( deip::chain::comment_object,
             (id)(author)(permlink)
...
CHAINBASE_SET_INDEX_TYPE( deip::chain::comment_object, deip::chain::comment_index )

FC_REFLECT( deip::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( deip::chain::comment_vote_object, deip::chain::comment_vote_index )
