...
public:
    ...
    asset reward_deip_balance = asset(0, deip_SYMBOL);
    asset reward_vesting_balance = asset(0, VESTS_SYMBOL);
    asset reward_vesting_deip = asset(0, deip_SYMBOL);
...
FC_REFLECT( deip::chain::vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )
CHAINBASE_SET_INDEX_TYPE( deip::chain::vesting_delegation_object, deip::chain::vesting_delegation_index )

FC_REFLECT( deip::chain::vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )
CHAINBASE_SET_INDEX_TYPE( deip::chain::vesting_delegation_expiration_object, deip::chain::vesting_delegation_expiration_index )
