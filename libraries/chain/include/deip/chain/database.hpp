...
public:
    ...
    share_type pay_curators(const research_object& research, const discipline_id_type& discipline_id, const share_type& reward);
    ...
    void reward_research_token_holders(const research_object& research, const share_type& reward);
