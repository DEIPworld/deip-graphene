...
public:
    ...
    const total_votes_object& get_total_votes(const total_votes_id_type& total_vote_id) const;
    ...
    bool total_vote_exists_by_content_and_discipline(const research_content_id_type& research_content_id, const discipline_id_type& discipline_id) const;
    ...
    review_vote_refs_type get_review_votes_by_content(const research_content_id_type& research_content_id) const;
    ...
    const total_votes_object& increase_total_used_expertise_amount(const total_votes_id_type& total_vote_id, const share_type& amount);
};
} // namespace chain
} // namespace deip
