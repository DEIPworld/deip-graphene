...
public:
    using contracts_refs_type = std::vector<std::reference_wrapper<const nda_contract_file_access_object>>;

    const nda_contract_file_access_object& get_file_access_request(const nda_contract_file_access_id_type& request_id);
