...
typedef allocator<std::pair<const discipline_id_type, std::pair<account_name_type, share_type>>> discipline_id_account_name_share_type_allocator_type;
typedef bip::map<discipline_id_type, std::pair<account_name_type, share_type>, std::less<discipline_id_type>, discipline_id_account_name_share_type_allocator_type> delegated_expertise_type_map;
