...
FC_REFLECT(deip::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration))
CHAINBASE_SET_INDEX_TYPE(deip::chain::transaction_object, deip::chain::transaction_index)
