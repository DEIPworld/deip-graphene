...
enum class nda_contract_status : uint16_t
{
    nda_contract_unknown = 0,
    ...
    FIRST = nda_contract_pending,
    LAST = nda_contract_expired
};
...
public:
    ...
    uint16_t status = static_cast<uint16_t>(nda_contract_status::nda_contract_pending);
...
FC_REFLECT_ENUM(deip::chain::nda_contract_status,
                 (nda_contract_unknown)
                 (nda_contract_pending)
                 (nda_contract_signed)
                 (nda_contract_declined)
                 (nda_contract_closed)
                 (nda_contract_expired))
