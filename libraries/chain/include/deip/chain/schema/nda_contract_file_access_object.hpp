...
typedef multi_index_container<nda_contract_file_access_object,
                                            indexed_by<
...
CHAINBASE_SET_INDEX_TYPE(deip::chain::nda_contract_file_access_object, deip::chain::contract_file_access_index)
