...
using deip::protocol::weight_type;
...
FC_REFLECT_TYPENAME(deip::chain::shared_authority::account_authority_map)
FC_REFLECT(deip::chain::shared_authority, (weight_threshold)(account_auths)(key_auths))
