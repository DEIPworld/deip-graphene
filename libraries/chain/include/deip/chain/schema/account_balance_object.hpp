...
typedef multi_index_container<account_balance_object,
            ...
            ordered_unique<tag<by_owner_and_asset>,
                    composite_key<account_balance_object,
                            member<account_balance_object,
                                   account_name_type,
                                   &account_balance_object::owner>,
                            member<account_balance_object,
                                    protocol::asset_symbol_type ,
...
FC_REFLECT( deip::chain::account_balance_object, (id)(asset_id)(symbol)(owner)(amount))
