...
void delete_comment_evaluator::do_apply(const delete_comment_operation& o)
{
    ...
    if (comment.parent_author != DEIP_ROOT_POST_PARENT)
    {
...
void comment_options_evaluator::do_apply(const comment_options_operation& o)
{
    ...
    FC_ASSERT(comment.percent_deips >= o.percent_deips, "A comment cannot accept a greater percent SBD.");

    _db._temporary_public_impl().modify(comment, [&](comment_object& c) {
        c.max_accepted_payout = o.max_accepted_payout;
        c.percent_deips = o.percent_deips;
...
void comment_evaluator::do_apply(const comment_operation& o)
{
    ...
    try
    {
        ...
        if (o.parent_author != DEIP_ROOT_POST_PARENT)
        {
            ...
            FC_ASSERT(parent->depth < DEIP_MAX_COMMENT_DEPTH,
                      "Comment is nested ${x} posts deep, maximum depth is ${y}.",
                      ("x", parent->depth)("y", DEIP_MAX_COMMENT_DEPTH));
        }
        ...
        if (itr == by_permlink_idx.end())
        {
            ...
            _db._temporary_public_impl().create<comment_object>([&](comment_object& com) {
                ...
                com.cashout_time = com.created + DEIP_CASHOUT_WINDOW_SECONDS;
...
void proposal_vote_evaluator::do_apply(const proposal_vote_operation& op)
{
    ...
    share_type weight = research_group_token_service.get_research_group_token_by_account_type(op.voter).amount;
