...
void dbs_research_group::check_research_group_existence(research_group_id_type research_group_id) const
{
...
void dbs_research_group_token::check_research_token_existence(const account_name_type& account_name,
...
{
    check_research_token_existence(account_name, research_group_id);
