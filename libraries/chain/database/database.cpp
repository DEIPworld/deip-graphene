...
asset database::distribute_reward(const asset& reward, const share_type& expertise)
{
    ...
    {
        push_virtual_operation(disciplines_eci_history_operation(disciplines_contributions, head_block_time()));
    }
...
void database::initialize_evaluators()
{
    ...
    _my->_evaluator_registry.register_evaluator<tokenize_research_evaluator>();
}
