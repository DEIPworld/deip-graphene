...
class blockchain_statistics_plugin : public deip::app::plugin
{
public:
...
FC_REFLECT(deip::blockchain_statistics::bucket_object,
    (id)(open)(seconds)(blocks)(bandwidth)(operations)(transactions)(transfers)(deip_transferred)(sbd_transferred)(
               ...
               new_reply_votes)(changed_reply_votes)(payouts)(deip_paid_to_authors)(transfers_to_common_tokens)(deip_to_common_tokens)(new_common_tokens_withdrawal_requests)(
               modified_common_tokens_withdrawal_requests)(common_tokens_withdraw_rate_delta)(common_tokens_withdrawals_processed)(
               finished_common_tokens_withdrawals)(common_tokens_withdrawn)(common_tokens_transferred)(sbd_conversion_requests_created)(
