...
statistics& statistics::operator+=(const bucket_object& b)
{
    ...
    this->transfers_to_common_tokens += b.transfers_to_common_tokens;
    this->deip_to_common_tokens += b.deip_to_common_tokens;
    this->new_common_tokens_withdrawal_requests += b.new_common_tokens_withdrawal_requests;
    this->common_tokens_withdraw_rate_delta += b.common_tokens_withdraw_rate_delta;
    this->modified_common_tokens_withdrawal_requests += b.modified_common_tokens_withdrawal_requests;
    this->common_tokens_withdrawals_processed += b.common_tokens_withdrawals_processed;
    this->finished_common_tokens_withdrawals += b.finished_common_tokens_withdrawals;
    this->common_tokens_withdrawn += b.common_tokens_withdrawn;
    this->common_tokens_transferred += b.common_tokens_transferred;
