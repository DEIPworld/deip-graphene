...
{
public:
    debug_node_api(const deip::app::api_context& ctx);
     ...
     */
    // not implemented
    // void debug_push_block( deip::chain::signed_block& block );
...
// clang-format off
FC_REFLECT(deip::plugin::debug_node::get_dev_key_args, (name))

FC_REFLECT(deip::plugin::debug_node::get_dev_key_result, (private_key)(public_key))

FC_API(deip::plugin::debug_node::debug_node_api,
       (debug_push_blocks)
