...
struct private_message_operation : public deip::protocol::base_operation
{
...
FC_REFLECT(deip::private_message::private_message_operation,
    (from)(to)(from_memo_key)(to_memo_key)(sent_time)(checksum)(encrypted_message))

DECLARE_OPERATION_TYPE(deip::private_message::private_message_plugin_operation)
FC_REFLECT_TYPENAME(deip::private_message::private_message_plugin_operation)
