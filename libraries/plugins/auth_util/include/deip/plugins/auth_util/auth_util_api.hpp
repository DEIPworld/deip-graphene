...
{
public:
    auth_util_api(const deip::app::api_context& ctx);
...
FC_REFLECT(deip::plugin::auth_util::check_authority_signature_params, (account_name)(level)(dig)(sigs))
FC_REFLECT(deip::plugin::auth_util::check_authority_signature_result, (keys))

FC_API(deip::plugin::auth_util::auth_util_api, (check_authority_signature))
