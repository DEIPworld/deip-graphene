...
FC_REFLECT(deip::follow::feed_entry, (author)(permlink)(reblog_by)(reblog_on)(entry_id))
FC_REFLECT(deip::follow::comment_feed_entry, (comment)(reblog_by)(reblog_on)(entry_id))
FC_REFLECT(deip::follow::blog_entry, (author)(permlink)(blog)(reblog_on)(entry_id))
FC_REFLECT(deip::follow::comment_blog_entry, (comment)(blog)(reblog_on)(entry_id))
FC_REFLECT(deip::follow::account_reputation, (account)(reputation))
FC_REFLECT(deip::follow::follow_api_obj, (follower)(following)(what))
FC_REFLECT(deip::follow::follow_count_api_obj, (account)(follower_count)(following_count))

FC_API(deip::follow::follow_api,
