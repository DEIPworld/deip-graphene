...
/**
 *  This index is maintained to get an idea of which authors are redeiped by a particular blogger and
 ...
 *  Give me all blog posts by [authors] that were redeiped by this blog
 */
...
typedef multi_index_container<follow_object,
    indexed_by<ordered_unique<tag<by_id>, member<follow_object, follow_id_type, &follow_object::id>>,
                                  ordered_unique<tag<by_following_follower>,
                                      composite_key<follow_object, member<follow_object, account_name_type,
                                                                       &follow_object::following>,
                                                     member<follow_object, account_name_type,
                       ...
                       member<blog_author_stats_object, blog_author_stats_id_type, &blog_author_stats_object::id>>,
                                     ordered_unique<tag<by_blogger_guest_count>,
                                         composite_key<blog_author_stats_object,
                                                        member<blog_author_stats_object, account_name_type,
                                                            &blog_author_stats_object::blogger>,
                                                        member<blog_author_stats_object, account_name_type,
                                                            &blog_author_stats_object::guest>,
                                                        member<blog_author_stats_object, uint32_t,
                                                            &blog_author_stats_object::count>>,
                                         composite_key_compare<std::less<account_name_type>,
                                                        std::less<account_name_type>, greater<uint32_t>>>>>
...
typedef multi_index_container<reputation_object,
    indexed_by<ordered_unique<tag<by_id>, member<reputation_object, reputation_id_type, &reputation_object::id>>,
                                  ordered_unique<tag<by_reputation>,
                                      composite_key<reputation_object, member<reputation_object, share_type,
                                                                           &reputation_object::reputation>,
                                                     member<reputation_object, account_name_type,
...
typedef multi_index_container<follow_count_object,
    indexed_by<ordered_unique<tag<by_id>, member<follow_count_object, follow_count_id_type, &follow_count_object::id>>,
                                  ordered_unique<tag<by_account>,
                                      member<follow_count_object, account_name_type, &follow_count_object::account>>,
                                  ordered_unique<tag<by_followers>,
                                      composite_key<follow_count_object, member<follow_count_object, uint32_t,
                                                                             &follow_count_object::follower_count>,
                                                     member<follow_count_object, follow_count_id_type,
...
FC_REFLECT_ENUM(deip::follow::follow_type, (undefined)(blog)(ignore))

FC_REFLECT(deip::follow::follow_object, (id)(follower)(following)(what))
CHAINBASE_SET_INDEX_TYPE(deip::follow::follow_object, deip::follow::follow_index)

FC_REFLECT(deip::follow::feed_object,
    (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id))
CHAINBASE_SET_INDEX_TYPE(deip::follow::feed_object, deip::follow::feed_index)

FC_REFLECT(deip::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id))
CHAINBASE_SET_INDEX_TYPE(deip::follow::blog_object, deip::follow::blog_index)

FC_REFLECT(deip::follow::reputation_object, (id)(account)(reputation))
CHAINBASE_SET_INDEX_TYPE(deip::follow::reputation_object, deip::follow::reputation_index)

FC_REFLECT(deip::follow::follow_count_object, (id)(account)(follower_count)(following_count))
CHAINBASE_SET_INDEX_TYPE(deip::follow::follow_count_object, deip::follow::follow_count_index)

FC_REFLECT(deip::follow::blog_author_stats_object, (id)(blogger)(guest)(count))
CHAINBASE_SET_INDEX_TYPE(deip::follow::blog_author_stats_object, deip::follow::blog_author_stats_index)
