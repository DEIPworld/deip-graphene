...
FC_REFLECT(deip::follow::follow_operation, (follower)(following)(what))
FC_REFLECT(deip::follow::reblog_operation, (account)(author)(permlink))

DECLARE_OPERATION_TYPE(deip::follow::follow_plugin_operation)

FC_REFLECT_TYPENAME(deip::follow::follow_plugin_operation)
