...
#include <deip/blockchain_history/schema/blockchain_objects.hpp>
...
FC_REFLECT_ENUM(deip::blockchain_history::applied_operation_type, (all)(not_virt)(virt)(market))

FC_REFLECT(deip::blockchain_history::filtered_all_operation_object, (id)(op))
CHAINBASE_SET_INDEX_TYPE(deip::blockchain_history::filtered_all_operation_object,
                         deip::blockchain_history::filtered_all_operation_index)
FC_REFLECT(deip::blockchain_history::filtered_not_virt_operation_object, (id)(op))
CHAINBASE_SET_INDEX_TYPE(deip::blockchain_history::filtered_not_virt_operation_object,
                         deip::blockchain_history::filtered_not_virt_operation_index)
FC_REFLECT(deip::blockchain_history::filtered_virt_operation_object, (id)(op))
CHAINBASE_SET_INDEX_TYPE(deip::blockchain_history::filtered_virt_operation_object,
                         deip::blockchain_history::filtered_virt_operation_index)
FC_REFLECT(deip::blockchain_history::filtered_market_operation_object, (id)(op))
CHAINBASE_SET_INDEX_TYPE(deip::blockchain_history::filtered_market_operation_object,
                         deip::blockchain_history::filtered_market_operation_index)