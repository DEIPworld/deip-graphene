...
{
public:
    block_info_api(const deip::app::api_context& ctx);
...
FC_REFLECT(deip::plugin::block_info::get_block_info_args, (start_block_num)(count))

FC_API(deip::plugin::block_info::block_info_api, (get_block_info)(get_blocks_with_info))
