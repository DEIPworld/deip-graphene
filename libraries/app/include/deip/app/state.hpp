...
struct extended_account : public account_api_obj
{
    ...
    asset vesting_balance; /// convert vesting_shares to vesting deip
    share_type reputation = 0;
...
FC_REFLECT( deip::app::vote_state, (voter)(weight)(rshares)(percent)(reputation)(time) )
FC_REFLECT( deip::app::account_vote, (authorperm)(weight)(rshares)(percent)(time) )

FC_REFLECT( deip::app::discussion_index, (category)(trending)(payout)(payout_comments)(trending30)(updated)(created)(responses)(active)(votes)(maturing)(best)(hot)(promoted)(cashout) )
FC_REFLECT( deip::app::tag_index, (trending) )
FC_REFLECT_DERIVED( deip::app::discussion, (deip::app::comment_api_obj), (url)(root_title)(pending_payout_value)(total_pending_payout_value)(active_votes)(replies)(author_reputation)(promoted)(body_length)(reblogged_by)(first_reblogged_by)(first_reblogged_on) )
