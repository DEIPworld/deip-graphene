...
BOOST_AUTO_TEST_CASE(reject_research_group_invite_apply)
{
    try
    {
        ...
        research_group_create(31, "name", "permlink", "description", 200, true, false);
...
BOOST_AUTO_TEST_CASE(research_update_apply)
{
    try {
        ...
        research_group_create(31, "name", "permlink", "description", 100, false, false);
...
BOOST_AUTO_TEST_CASE(make_review_grant_application)
{
    ...
    setup_research_group(31, "name", "research_group", "research group", 0, true, false, accounts);
