...
//            = research_group_create_by_operation("alice", "permlink rg1", "description rg1", 50);
//        auto& _research_group_2
//            = research_group_create_by_operation("alice", "permlink rg2", "description rg2", 50);
//
...
//
//        BOOST_CHECK(_research_group_1.total_tokens_amount == DEIP_100_PERCENT);
//        BOOST_CHECK(_research_group_2.total_tokens_amount == DEIP_100_PERCENT);
//
...
//        BOOST_CHECK(_research_group_1_token.amount == 50 * DEIP_1_PERCENT && _research_group_2_token.amount == 50 * DEIP_1_PERCENT);
//
//        BOOST_CHECK_THROW((db.get<research_group_invite_object, by_id>(0)), std::out_of_range);
...
//                          std::out_of_range);
//        BOOST_CHECK(_research_group_1.total_tokens_amount == DEIP_100_PERCENT && _research_group_2.total_tokens_amount == DEIP_100_PERCENT);
...
BOOST_AUTO_TEST_CASE(reject_research_group_invite_apply)
{
    try
    {
        ...
        auto& research_group = research_group_create(1, "permlink", "description", 200, 50);
