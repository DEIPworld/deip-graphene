...
class contract_service_fixture : public clean_database_fixture
{
 public:
    contract_service_fixture()
           : data_service(db.obtain_service<dbs_nda_contract>())
   {
    ...
    dbs_nda_contract& data_service;
};

BOOST_FIXTURE_TEST_SUITE(nda_contract_service_tests, contract_service_fixture)
