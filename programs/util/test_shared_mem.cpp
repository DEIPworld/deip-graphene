    ...
    try
    {
        ...
        */
        book_container* pbc = seg.find_or_construct<book_container>("book container")(
            book_container::ctor_args_list(), book_container::allocator_type(seg.get_segment_manager()));
        ...
        bip::deque<book, book::allocator_type>* deq = seg.find_or_construct<bip::deque<book, book::allocator_type>>(
