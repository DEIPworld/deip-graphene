...
Please read these instructions before submitting issues to the Deip GitHub repository. The issue tracker is for bugs and specific implementation discussion **only**. It should not be used for other purposes, as described below.
...
Do **not** use the issue tracker to suggest enhancements or improvements to the platform. If there is a well vetted idea that has the support of the community that you feel should be considered by the development team, please email it to [blockchain-support@deip.com](mailto:blockchain-support@deip.com) for review.
