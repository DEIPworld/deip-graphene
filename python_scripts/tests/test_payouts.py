...
# local imports
from deipdebugnode import DebugNode
...
def main( ):
   ...
   parser = ArgumentParser( description='Run a deipd debug node on an existing chain, trigger a hardfork' \
...
def run_deipd_tests( debug_node ):
   from deipapi.deipnoderpc import DeipNodeRPC
   ...
   try:
      ...
      rpc = DeipNodeRPC( 'ws://127.0.0.1:8095', '', '' )
